...
const I18n = (() => {
  ...
  const STRINGS = {
    es: {
      ...
      "missions.sub": "Veintidós pruebas te esperan: cuidá, explorá, resolvé, sobreviví y arriesgate.",
    ...
    en: {
      ...
      "missions.sub": "Twenty-two trials await: nurture, explore, solve, survive and take risks.",
